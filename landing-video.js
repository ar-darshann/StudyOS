(function(){
  ...
  const STYLE='.feature-ai .demo-shell{display:flex!important;align-items:center;justify-content:center;min-height:390px;background:none!important;background-image:none!important}.feature-ai .demo-shell::before,.feature-ai .demo-shell::after{content:none!important;display:none!important;background:none!important;background-image:none!important}.feature-ai .chat-demo{display:flex!important;align-items:center;justify-content:center;min-height:390px!important;overflow:hidden!important;animation:none!important;background:none!important;background-image:none!important}.feature-ai .chat-demo::before,.feature-ai .chat-demo::after{content:none!important;display:none!important;background:none!important;background-image:none!important}.feature-ai .chat-demo>*{display:none!important}.nivo-intro-only{width:100%;min-height:390px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;box-sizing:border-box;background:transparent!important}.nivo-intro-mark{width:92px;height:92px;border-radius:28px;display:grid;place-items:center;background:var(--landing-accent,#3B82F6);color:#fff;font:900 52px Arial;margin-bottom:24px}.nivo-intro-eyebrow{font:700 11px Arial;letter-spacing:2px;color:var(--landing-muted,#8C96A5);margin-bottom:10px}.nivo-intro-only h3{margin:0;color:var(--landing-text,#F5F7FA);font:800 42px Arial;letter-spacing:-1px}.nivo-intro-only p{margin:12px 0 0;color:var(--landing-muted,#8C96A5);font:400 15px Arial}.feature-ai .chat-demo .chat-messages,.feature-ai .chat-demo .bubble{display:none!important;animation:none!important}';
  function clean(){
